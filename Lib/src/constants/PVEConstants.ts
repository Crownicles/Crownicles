...
export abstract class PVEConstants {
	...
	static readonly NON_FINAL_BOSS_MONSTER_LEVEL_RANDOM_OFFSET = {
		MIN: -20,
		MAX: 3
	} as const;

	static readonly NON_FINAL_BOSS_MONSTER_LEVEL_RANDOM_RANGE =
		PVEConstants.NON_FINAL_BOSS_MONSTER_LEVEL_RANDOM_OFFSET.MAX
		- PVEConstants.NON_FINAL_BOSS_MONSTER_LEVEL_RANDOM_OFFSET.MIN + 1;

	static readonly FINAL_BOSS_MONSTER_LEVEL_RANDOM_OFFSET = {
		MIN: -10,
		MAX: 5
	} as const;

	static readonly FINAL_BOSS_MONSTER_LEVEL_RANDOM_RANGE =
		PVEConstants.FINAL_BOSS_MONSTER_LEVEL_RANDOM_OFFSET.MAX
		- PVEConstants.FINAL_BOSS_MONSTER_LEVEL_RANDOM_OFFSET.MIN + 1;
