export enum NumberChangeReason {
	...
	APARTMENT_BUY,
	APARTMENT_RENT_CLAIM,
	ROYAL_BLACKSMITH_UPGRADE,
	ROYAL_BLACKSMITH_UPGRADE_GEMS,
	TOKEN_MERCHANT_CHARITY,
	SCRAP_DEALER_RECYCLE,
	TOURNAMENT_REWARD
}
...
export const ShopItemTypeToString: Record<ShopItemType, string> = {
	...
	[ShopItemType.TOKEN_CHARITY]: "tokenCharity"
};
