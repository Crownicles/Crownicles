...
export type FromServerPacketLike<Packet extends FromServerPacket> = new () => Packet;
...
export type FromClientPacketLike<Packet extends FromClientPacket> = new () => Packet;
