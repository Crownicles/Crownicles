...
type GardenPlantOperation = Extract<GardenOperation, { type: typeof GARDEN_OPERATIONS.PLANT }>;
type GardenCompostOperation = Extract<GardenOperation, { type: typeof GARDEN_OPERATIONS.COMPOST }>;

function validatePlantOperation(operation: GardenPlantOperation): GardenPlantOperation {
...
function validateCompostOperation(operation: GardenCompostOperation): GardenCompostOperation {
...
function validateOperation(operation: GardenOperation): GardenOperation {
	...
	switch (operation.type) {
		...
		case GARDEN_OPERATIONS.PLANT:
			return validatePlantOperation(operation);
		case GARDEN_OPERATIONS.COMPOST:
			return validateCompostOperation(operation);
