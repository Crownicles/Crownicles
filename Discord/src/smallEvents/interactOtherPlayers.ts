			...
			new CrowniclesSmallEventEmbed(
				...
				StringUtils.getRandomTranslation(
					...
					lng,
					{
						...
						weapon: DisplayUtils.getSimpleWeaponDisplay(data.weaponId, lng),
						armor: DisplayUtils.getSimpleArmorDisplay(data.armorId, lng),
						object: DisplayUtils.getSimpleObjectDisplay(data.objectId, lng),
						potion: DisplayUtils.getSimplePotionDisplay(data.potionId, lng),
