...
function DomainResult({outcome}: {outcome: Outcome}): ReactNode {
	if (outcome.type === "notary") return <>
		...
		<Panel><KeyValue label={i18n.t("app:guildDomain.cost")} value={formatMoney(outcome.cost)} /></Panel>
	</>;
	...
	if (outcome.type === "deposit") return <Panel>
	...
	if (outcome.type === "food") return <Panel>
