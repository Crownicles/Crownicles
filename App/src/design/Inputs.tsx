...
const styles = StyleSheet.create({
	...
	input: {minHeight: 44, minWidth: 0, padding: Theme.spacing.md, borderWidth: 1, borderColor: Theme.colors.line, borderRadius: Theme.radius, backgroundColor: Theme.colors.paper, color: Theme.colors.ink, fontFamily: Theme.fonts.regular, fontSize: Theme.fontSize.body}
});
