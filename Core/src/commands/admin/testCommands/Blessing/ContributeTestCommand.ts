...
const contributeTestCommand: ExecuteTestCommandLike = async (player, args, response) => {
	...
	const triggered = await blessingManager.contribute(amount, player.keycloakId, response);
